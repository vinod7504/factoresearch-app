...
export default function AboutUsScreen() {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Disclosures / SEBI</Text>
      <Text style={styles.subtitle}>About Facto Research and regulatory disclosures</Text>

      <View style={styles.card}>
        <Paragraph>15 years of market mastery, institutional-grade analysis, and a commitment to truth through data.</Paragraph>
        ...
        <Paragraph>
          All investment decisions remain subject to market risk. Research views are informational and should be read together with investor suitability, risk profiling, and personal financial context.
        </Paragraph>
        ...
        <Text style={styles.sectionTitle}>Disclosure Notes</Text>
        <Paragraph>
          Past performance does not guarantee future returns. Securities investments are subject to market volatility. Review the latest recommendation detail, stop loss, and target assumptions before acting.
        </Paragraph>
        <Paragraph>
          Clients should complete KYC, maintain updated contact information, and review grievance redressal channels for escalation support when required.
        </Paragraph>
...
const styles = StyleSheet.create({
  ...
  subtitle: { marginTop: 4, marginBottom: 12, color: "#334155", fontWeight: "700" },
  card: { backgroundColor: "#ffffff", borderColor: "#dbe3ee", borderWidth: 1, borderRadius: 12, padding: 14 },
  sectionTitle: { marginTop: 10, marginBottom: 6, color: "#0f172a", fontWeight: "800", fontSize: 16 },
  paragraph: { color: "#334155", lineHeight: 20, marginBottom: 8 },
  websiteButton: { marginTop: 8, backgroundColor: "#2e52b7", borderRadius: 10, paddingVertical: 12, alignItems: "center" },
  websiteButtonText: { color: "#ffffff", fontWeight: "700" }
});
